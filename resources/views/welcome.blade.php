    ...
    <div class="row" style="width: 100%;margin:0px;padding:0px;height: 100%;">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        @foreach ($estacionesZonaOccidental as $estacion)
                                            <li class="list-group-item">
                                                <a href="{{ url('estacion/' . $estacion->id) }}"
        ...
        <div class="col-3 right">
            <div class="aside" style="border-radius: 5px;padding:10px">
                <h6>Variables generales</h6>
                @foreach ($variables as $variable)
                <div class="d-flex align-items-center mb-2">
                    <img src="{{ asset($variable['icono_file_path']) }}" alt="{{ $variable['nombre'] }}" style="max-height: 30px; max-width: 30px; margin-right: 10px;">
  ...
  <path d="M10.5 1.5a.5.5 0 0 0-1 0v1a.5.5 0 0 0 1 0zm3.743 1.964a.5.5 0 1 0-.707-.707l-.708.707a.5.5 0 0 0 .708.708zm-7.779-.707a.5.5 0 0 0-.707.707l.707.708a.5.5 0 1 0 .708-.708zm1.734 3.374a2 2 0 1 1 3.296 2.198q.3.423.516.898a3 3 0 1 0-4.84-3.225q.529.017 1.028.129m4.484 4.074c.6.215 1.125.59 1.522 1.072a.5.5 0 0 0 .039-.742l-.707-.707a.5.5 0 0 0-.854.377M14.5 6.5a.5.5 0 0 0 0 1h1a.5.5 0 0 0 0-1z"/>
        ...
        function onLocationFound(e) {
            ...
            L.marker(e.latlng).addTo(map)
                .bindPopup("Estaciones meteorológicas ubicadas a 50 kilómetros de tí.").openPopup();
